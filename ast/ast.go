...
// Satisfy the Node interface TokenLIteral requirement
...
// Satisfy the Node interface String requirement
...
// Expression statement has a token and an expression
...
func (es *ExpressionStatement) String() sting {
